package com.ipland.azure.bot.invoker;
...
import com.ipland.azure.bot.invoker.auth.Authentication;
import com.ipland.azure.bot.invoker.auth.HttpBasicAuth;
import com.ipland.azure.bot.invoker.auth.ApiKeyAuth;
import com.ipland.azure.bot.invoker.auth.OAuth;
...
public class ApiClient {
    ...
    protected void init() {
        ...
        setUserAgent("Microsoft-bot");

        // Setup authentications (key: authentication name, value: authentication).
        authentications = new HashMap<String, Authentication>();
        authentications.put(oAuth.getClass().getName(), oAuth);
